...
class FR:
    ...
    def faceRecoModel(self, input_shape):
        """
        ...
        # Inception 1: a/b/c
        X = self.inception_block_1a(X)
        X = self.inception_block_1b(X)
        X = self.inception_block_1c(X)
        
        # Inception 2: a/b
        X = self.inception_block_2a(X)
        X = self.inception_block_2b(X)
